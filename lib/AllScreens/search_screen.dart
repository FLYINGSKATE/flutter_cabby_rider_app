import 'package:cabby_rider_app/AllScreens/placePredictions.dart';
                ...
                children: [
                  ...
                  Stack(
                    children: [
                      ...
                      Center(
                        child: Text("Set Drop Off",style: TextStyle(fontSize: 18.0,fontFamily: "Bolt Semibold"),),
                      )
                    ],
                  ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 2.0,),
                      Text(placePredictions.secondary_text,style: TextStyle(fontSize: 12.0,color: Colors.grey),),
                      SizedBox(height: 8.0,),
                    ],
                  ),
                )
